...
/**
 * 🔒 Spring Security 6 & JWT Security Filter Chain Configuration.
 * 
 * Configura o gerenciamento de sessões Stateless, autenticação via Bearer JWT,
 * suporte a CORS Multi-Tenant e proteção de endpoints REST contra CSRF.
 */
@Configuration
@EnableWebSecurity
